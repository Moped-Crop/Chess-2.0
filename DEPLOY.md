...
| `SMTP_PORT` | `465` |
| `SMTP_USER` | адрес Gmail-ящика для писем |
| `SMTP_PASS` | App Password из Google (16 символов, не обычный пароль) |
| `SMTP_FROM` | `"Chess 2 · ASCENT" <ящик@gmail.com>` |
| `APP_URL` | публичный домен сайта, напр. `https://chess2-production.up.railway.app` (нужен для ссылок в письмах) |
